...
const ListedProjectTypes = () => {
  ...
  const ProjectTypes = [
    ...
    {id: 3,
      ...
      color:"yellow",
      project: "react",
      description: "Develop modern, interactive user interfaces with React.js.",
    },
    {id: 4,
      stack: "Full Stack",
      icon: "Globe",
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-5xl mx-auto">
      {ProjectTypes.map((project) => {
        ...
        return (
          ...
          }} key={project.id} className="p-6 rounded-lg bg-card border hover:border-primary/50 transition-colors">
